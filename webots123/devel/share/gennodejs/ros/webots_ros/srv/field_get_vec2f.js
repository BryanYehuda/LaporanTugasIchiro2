...
class field_get_vec2fRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type field_get_vec2fRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type field_get_vec2fRequest
    let len;
    let data = new field_get_vec2fRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new field_get_vec2fRequest(null);
...
class field_get_vec2fResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type field_get_vec2fResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type field_get_vec2fResponse
    let len;
    let data = new field_get_vec2fResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new field_get_vec2fResponse(null);
...
module.exports = {
  Request: field_get_vec2fRequest,
  Response: field_get_vec2fResponse,
  md5sum() { return '5ba75d9d095ca14bcb57c58ac3b63422'; },
  datatype() { return 'webots_ros/field_get_vec2f'; }
};
