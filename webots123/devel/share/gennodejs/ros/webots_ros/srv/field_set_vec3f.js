...
class field_set_vec3fRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type field_set_vec3fRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type field_set_vec3fRequest
    let len;
    let data = new field_set_vec3fRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new field_set_vec3fRequest(null);
...
class field_set_vec3fResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type field_set_vec3fResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type field_set_vec3fResponse
    let len;
    let data = new field_set_vec3fResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new field_set_vec3fResponse(null);
...
module.exports = {
  Request: field_set_vec3fRequest,
  Response: field_set_vec3fResponse,
  md5sum() { return 'e0edef5860d282e4d35ef264e28feecc'; },
  datatype() { return 'webots_ros/field_set_vec3f'; }
};
