...
class node_set_velocityRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type node_set_velocityRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type node_set_velocityRequest
    let len;
    let data = new node_set_velocityRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new node_set_velocityRequest(null);
...
class node_set_velocityResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type node_set_velocityResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type node_set_velocityResponse
    let len;
    let data = new node_set_velocityResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new node_set_velocityResponse(null);
...
module.exports = {
  Request: node_set_velocityRequest,
  Response: node_set_velocityResponse,
  md5sum() { return 'bbe5d1dd420b6f268ed5aee8db339832'; },
  datatype() { return 'webots_ros/node_set_velocity'; }
};
